...
#include "ThreadHandlersdfsdfMessage.h"
...
{																																													
	Dis.AddHandler(static_cast<uint32_t>(MessageId::sdfsdf), std::bind(&OnMessageProcess<ThreadHandlersdfsdfMessage, sdfsdfMessage>, std::placeholders::_1, std::placeholders::_2));	
